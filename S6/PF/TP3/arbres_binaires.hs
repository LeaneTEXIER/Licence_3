...
prop_hauteurPeigne' xs = length xs == hauteur' (peigneGauche xs)
-- Elle verifie que la fonction hauteur donne un bon résultat.
...
-- Question 10 --
-- Les peignes à gauche complets sont ceux de hauteur 1 ou 0.
...
-- En effet, un arbre complet de hauteur 20 à 2097151 noeuds et feuilles.
-- Cela prend donc beaucoup de temps et d'espace à ghci.
-- Ce n'est donc pas raisonnable de construire des arbres complets de hauteur 20 ou plus.

-- Question 12 --
infinityArgument :: a -> [a]
infinityArgument = iterate id
