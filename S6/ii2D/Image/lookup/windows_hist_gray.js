...
lookup_windows.MeanHistGraySameSizeTemplate=function(
...
lookup_windows.MeanHistGraySameSizeTemplate.prototype.process=function(in_imageData) {
  ...
  var similarity_task=new pixels_similarity.MeanHistGraySimilarityTask(lookup_dataset,{});
