ToGrayMaxTask=function(opt_options) {
...
ToGrayMaxTask.prototype.process=function(imageData) {
...
PartialGrayMaxTask=function(opt_options) {
...
PartialGrayMaxTask.prototype.process=function(imageData) {
  var pixels = imageData.data;
  var p = new Array();
  for (var i = 0; i < imageData.height*imageData.width*4; i++){
      p[i]=pixels[i];
