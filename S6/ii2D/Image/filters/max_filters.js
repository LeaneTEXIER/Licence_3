ToMaxTask=function(opt_options) {
...
ToMaxTask.prototype.process=function(imageData) {
...
PartialMaxTask=function(opt_options) {
...
PartialMaxTask.prototype.process=function(imageData) {
  var pixels = imageData.data;
  var p = new Array();
  for (var i = 0; i < imageData.height*imageData.width*4; i++){
      p[i]=pixels[i];
