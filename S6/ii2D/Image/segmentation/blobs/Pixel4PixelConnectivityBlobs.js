...
blobs.Pixel4PixelConnectivityBlobs=function(opt_options) {
  this.metric = opt_options.metric;
  this.threshold=opt_options && opt_options.threshold ? opt_options.threshold : 0;
}

blobs.Pixel4PixelConnectivityBlobs.prototype.analyse_neighbours=function(in_imgData, x0, y0) {
...
blobs.Pixel4PixelConnectivityBlobs.prototype.update_bbox=function(id,bbox,x,y,mean) {
...
blobs.Pixel4PixelConnectivityBlobs.prototype.process=function(in_imgData,out_imgData) {
  var blobs_arr=[]
