...
/* Maximisation de la richesse des parcelles */
maximize richesse_parcelle :
  sum {l in LEGUMES, p in PARCELLES} (est_affecte[l,p]*(richesse_initiale[p]-besoin_richesse[l]+apport_richesse[l]));
...
solve;
display est_affecte, richesse_parcelle;
